...
'	.contentMainTable {width: 100% !important; margin: auto !important;}' +
'	.single-column {width: 100% !important; margin: auto !important;}' +
'	.multi-column {width: 100% !important; margin: auto !important;}' +
'	.imageBlockWrapper {width: 100% !important;	margin: auto !important;}}' +
...
'<!--[if mso | IE]>' +
'    <style>' +
'        .list-block-outlook-outside-left { margin-left: -18px;}' +
'        .list-block-outlook-outside-right { margin-right: -18px; }' +
'        a:link, span.MsoHyperlink { mso-style-priority:99; display: inline-block;  color: #5457FF; text-decoration: none; font-style: normal; font-weight: normal; }' +
'    </style><![endif]-->' +
'    </head>' +
...
'    <tr class="wp-block-editor-spacerblock-v1"><td style="background-color:#F5F6F8;line-height:50px;font-size:50px;width:100%;min-width:100%">&nbsp;</td></tr><tr class="wp-block-editor-imageblock-v1"><td style="background-color:#ffffff;padding-top:0;padding-bottom:0;padding-left:0;padding-right:0" align="center"><table align="center" width="640" class="imageBlockWrapper" style="width:640px" role="presentation"><tbody><tr><td style="padding:0"><img src="https://api.smtprelay.co/userfile/c5888168-cd75-4348-8622-a06b97dffbe9/book01_Christmas02.jpg" width="640" height="" alt="" style="border-radius:0px;display:block;height:auto;width:100%;max-width:100%;border:0" class="g-img"></td></tr></tbody></table></td></tr><tr class="wp-block-editor-headingblock-v1"><td valign="top" style="background-color:#ffffff;display:block;padding-top:64px;padding-right:32px;padding-bottom:32px;padding-left:32px;text-align:center"><p style="font-family:Open Sans, sans-serif;text-align:center;line-height:36.80px;font-size:32px;background-color:#ffffff;color:#000000;margin:0;word-break:normal" class="heading1">Dear ,</p></td></tr><tr class="wp-block-editor-paragraphblock-v1"><td valign="top" style="padding:0px 32px 32px 32px;background-color:#ffffff"><p class="paragraph" style="font-family:Open Sans, sans-serif;text-align:left;line-height:30.00px;font-size:15px;margin:0;color:#5f5f5f;word-break:normal">        Thank you for sharing the passion for creating synchronicities to change your faith and the World.  In 2024, I am launching my new online course about creating synchronicities with 10 hours of theory, exercises and examples.<br>I will send you an email when it becomes available.<br><br><strong>Please click the button with the link to the e-book.</strong></p></td></tr><tr class="wp-block-editor-buttonblock-v1" align="center"><td style="background-color:#ffffff;padding-top:20px;padding-right:20px;padding-bottom:60px;padding-left:20px;width:100%" valign="top"><table role="presentation" cellspacing="0" cellpadding="0" class="button-table"><tbody><tr><td valign="top" class="button-td button-td-primary" style="cursor:pointer;border:none;border-radius:4px;background-color:#5457ff;font-size:16px;font-family:Open Sans, sans-serif;width:fit-content;color:#ffffff"><a style="color:#ffffff" href="https://drive.google.com/file/d/1amIy8423DNc-uJHxX8eDJt97rSJA3AC0/view">' +
