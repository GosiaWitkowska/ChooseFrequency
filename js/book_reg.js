...
'<strong>Do you recognise synchronicities around you, or do you still call them coincidences?</strong> <br> ' + 
'For example, when you want to attend an event but as a VIP guest. To cover the difference in pricing, you receive an unexpected refund from the insurance you purchased years ago. <br>' +
'When you need a formal outfit for your sister''s wedding and you do not have any in your wardrobe. To find in your email inbox a ten-day sales offer for elegant dresses and suits. <br>' +
'When you dream about sharing your message and showing people the easier path. To find yourself in a book club society and sign up for a course, "How to write a book in 90 days.", where they teach you how to self-publish. <br>' +
'Would you want to create these opportunities yourself, using the power of your thoughts and amplifying them with high-vibing emotions? <br>' +
'Do not wait for others to learn it before you to play the role in their synchronicities. Become a magician, too. <br>' +
